...
Sammanställt, huvud- och felterm, erhåller vi följande sats:

\begin{theorem}[Eratosthenes generaliserade såll]\label{thm:EratosthenesSieve}
Med notationen från avsnitt \ref{sallproblemet} och antagandena nämnda tidigare i detta avsnitt, så gäller att
\begin{align*}
