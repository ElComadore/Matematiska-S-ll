...
Flyttar vi in summan innanför ordo-tecknet så kan vi förenkla den med Rankins trick som, enligt \cite[s.68]{cojocarumurty} säger att indikator funktionen, \(1_{n \leq x} \leq \frac{x}{n}\). Därav skriver vi 
\begin{align*}
