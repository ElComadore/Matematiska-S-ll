...
\begin{equation*}
    ...
    \end{cases}
\end{equation*}
som vi, bland annat, kommer se förenklar inklusion-exklusionsprincipen i nästa kapitel. Två andra viktiga egenskaper hos Möbiusfunktionen är följande egenskap,
\begin{equation*}
