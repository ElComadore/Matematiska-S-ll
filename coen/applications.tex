...
Att vår kod hittar ungefär 100 färre primtal än förväntat efter 20 000 heltal och ungefär 2000 färre primtal efter \(2.5\times10^9\) heltal är mycket rimligt då felet i \eqref{app.primes.PNT} kan som bäst vara \(O(2\Delta)^{1/2 + \varepsilon}),\; \varepsilon > 0\), under antagandet att Riemannhypotesen stämmer \cite[Kapitel 5]{RiemannErr}.
...
För att ge intuition för det förväntade avståndet och mer stöd till vår kod så analyserar vi nu de primtalsgap som finns i listan av primtal vi generad. Datan redovisas i figur \ref{fig:res.gap}.
