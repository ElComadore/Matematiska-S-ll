...
Återigen stöder detta resultat legitimiteten av vår kod eftersom den bygger på den välkända resultaten av primtalssatsen.

Om vi återgår till primtalstvillingar så ger figuren även något om dem. 
...
Förmodan har undersökts direkt med hjälp numeriska uppskattningsmetoder \cite{primeGap} som har lyckats visa att 6 är hoppmästaren fram till \(\approx 1.74\cdot10^{35}\) och att 30 är hoppmästaren mellan föregående och \(\approx 10^{425}\).
