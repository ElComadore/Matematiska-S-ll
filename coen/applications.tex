\todo{Allmän källhänvissning kräv här nere}
...
\todo{Diskussion needs works, going to be rewritten from scratch prolly}
...
\todo{Introducera de förändringarna som utfördes för att tillåta koden att bestämma storleken på primtalsgapp. Koppla till inledningen och väd dettahar att göra med sållteori}
\begin{figure}[H]
    \centering
