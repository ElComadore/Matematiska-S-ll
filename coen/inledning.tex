...
\end{enumerate}
Då man har tillämpat klart Eratosthenes ursprunglig såll, blir alla tal med cirklar kring sig alla primtal som är mindre än övergränsen du valde. Även om det har gått nästan två årtusenden sedan upptäckten av Eratosthenes ursprunglig såll har det fortfarande samband med nutidens matematiska såll; samband som en fokus på delbarhet och, följaktligen, specifika modulo klasser av primtal. 
