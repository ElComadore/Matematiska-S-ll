...
%\usepackage{hyperref}  % Flyttad till lägre ned
%\usepackage{csquotes}  % Flyttad till lägre ned
\usepackage{amsthm}
\usepackage{amssymb}
\usepackage{commath}
\usepackage{array}
...
\section{Bevis av (\ref{Thm.1.4.4}) och \texorpdfstring{\(\sum_{p \leq z} \frac{1}{p} = \log \log z + O(1)\)}{Summan av primtalsreciproker}}
