...
\usepackage{verbatim}
\usepackage{comment}  % Tillagt av Nils
\usepackage{multirow} % Tillagt av Nils
\usepackage{float}    % Tillagt av Nils
...
\newcommand{\titel}{Matematiska såll och dess tillämpningar} %Skriv in projektets/rapportens titel här
...
\section{Eratosthenes såll och programmering} \label{partB}
...
\subsection{Implementation i Python}\label{partB.implementering}
