...
$\lfloor (n+\Delta)/m \rfloor\cdot m$,
%\begin{equation} \label{helf.nprim}
%    n' := \left\lfloor \frac{n+\Delta}{m} \right\rfloor\cdot m,
%\end{equation}
vilken givetvis är mindre än eller lika med
$n+\Delta$.
%$\frac{n+\Delta}{m}\cdot m = n+\Delta$.
Vidare inspekterar vi villkoret $n'>m$, 
där definitionen av $n'$ ger oss att
%där (\ref{helf.nprim}) ger oss att 
\begin{equation*}
    n'>m \iff
