...
\end{equation*}
eftersom $1\leq\Delta\leq n$. Detta ger i sin tur att
\begin{equation*}
...
\begin{myitemize}
    ...
    Detta eftersom grafikkortet ofta visar sig snabbare än processorn på att utföra denna typ av uppgift.
\end{myitemize}
