...
Vi nöjer oss med att beskriva huvudidéen bakom Bruns såll och tar stöd i \cite[kap 6.2]{cojocarumurty} för att göra detta.

Med målet att förminska feltermerna i Eratosthenes generaliserade såll, lät Viggo Brun modifierade uttrycket (\ref{inclusionexclusion}). 
