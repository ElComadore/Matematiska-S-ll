...
När den norska matematikern Viggo Brun (1881-1978) publicerade artikeln \textit{Über das Goldbachsche Gesetz und die Anzahl der Primzahlpaare} år 1915, var han den första att bygga vidare på Eratosthenes idéer. 
I artikeln presenterade Brun ett såll som numera kallas Bruns såll och fyra år senare använde han det för att bevisa att summan av reciproker $\frac{1}{p_1}+\frac{1}{p_2}+...$ av primtaltvillingar $p_1,p_2,...$ konvergerar. I detta stycke ges en kortfattad beskrivning av Bruns såll och ett exempel taget ur \cite[Kap 6.2]{cojocarumurty} på hur sållet kan tillämpas för att ge ett resultat som angränsar till primtalstvillingsförmodan.
