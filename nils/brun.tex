...
Att det sista antagandet i sats \ref{brun.thm.brun} är uppfyllt kan vi se genom användning av (\ref{Thm.1.4.4}) som tillsammans med $\omega(p)\leq2$ ger oss att
\begin{equation*}
...
har vi att feltermen går mot noll då $x\to\infty$, och vi får slutligen:
\begin{theorem}
